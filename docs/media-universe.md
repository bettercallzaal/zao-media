...
Tracker page: https://bettercallzaal.github.io/zao-media/tracker.html (yes/no per item: video, transcript, socials, clips, needs-publish). CSV: media-crm.csv in repo root, regenerated by every build. Google Sheet LIVE: https://docs.google.com/spreadsheets/d/10695ExQxCAPDHW1kep70Pbnor-AkM11RS4ObhxWjtr0/edit - pulls media-crm.csv via IMPORTDATA on open, always current, no re-exports needed. (Old 117-row snapshot sheet 1rg71nJ... is superseded - safe to trash.)
